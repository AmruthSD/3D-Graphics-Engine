...
void WindowHandler::transitionImageLayout(VkImage image, VkFormat format,
...
void WindowHandler::copyBufferToImage(VkBuffer buffer, VkImage image,
...
void WindowHandler::createTextureImageView() {
  textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB,
                                     VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
}

void WindowHandler::createTextureSampler() {
